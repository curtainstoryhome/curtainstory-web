...
export const PANELS = [
  {
    ...
    sub: "PORTFOLIO",
    icon: "photo",
    visual: { type: "illus", kind: "gallery" },
  ...
  },
  {
    ...
    sub: "SERVICES",
    icon: "grid",
    visual: { type: "illus", kind: "materials" },
  ...
  },
  {
    ...
    sub: "FREE QUOTE",
    icon: "tag",
    visual: { type: "illus", kind: "quote", bg: "sage" },
